                ...
                <div className="flex">
                  {testimonials.map((testimonial, index) => (
                    <div key={testimonial.id} className="w-full flex-shrink-0 px-2 sm:px-4">
                      <div className="p-6 sm:p-8 md:p-10 rounded-2xl bg-linear-to-br from-purple-900/30 to-purple-900/20 border border-purple-500/30 hover:border-purple-500/60 transition duration-300 backdrop-blur-sm">
                        {/* Stars */}
                        ...
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-linear-to-br from-purple-400 to-purple-600 flex items-center justify-center flex-shrink-0">
