...
export default function Page() {
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-black-600 to-blue-700 text-white flex items-center py-20">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">

        {/* LEFT CONTENT */}
        <div className="space-y-5 ml-10">

          <h1 className="font-sora text-5xl md:text-6xl font-extrabold leading-tight font-sora">
